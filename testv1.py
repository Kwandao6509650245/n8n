...
# translated_thai_to_english = translate_text_googletrans(text_to_translate_thai, dest_language='en')
# print(f"'{text_to_translate_thai}' (Thai) translated to English: '{translated_thai_to_english}'")
